...
// the intrinsics header explicitly so this file does not depend on that.
#include <immintrin.h>
  ...
  // includes it for MSVC builds, but include it here too so this file does not
  // depend on that - the include guards make it free.
  #include <intrin.h>
